...
//variante, en caso de no poder utilizar matriz auxiliar

/* void transpuesta(int matriz[][5], int dimension)
{
    int temporaldei;
    int i, j;
    for (i = 0; i < dimension; i++)
    {
        for (j = 0; j < dimension && j!=i ; j++)
        {
            swap(matriz[j][i], matriz[i][j]);
        }
    }
} */
...
int main()
{
    ...
    int matriz[dim5][dim5]{36, 7, 19, 28, 45,
                           ...
                           39, 47, 14, 4, 23,
                           16, 38, 8, 27, 44};
    int matriz1[dim5][dim5]{}; // matriz auxiliar
